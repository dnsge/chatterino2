...
KeyboardSettingsPage::KeyboardSettingsPage()
{
    ...
    form->addItem(new QSpacerItem(16, 16));
    form->addRow(keyLabel("Ctrl + T"), new QLabel("Create new split"));
    form->addRow(keyLabel("Ctrl + W"), new QLabel("Close current split"));
    form->addRow(keyLabel("Ctrl + G"), new QLabel("Reopen last closed split"));

    form->addRow(keyLabel("Ctrl + Shift + T"), new QLabel("Create new tab"));
    form->addRow(keyLabel("Ctrl + Shift + W"), new QLabel("Close current tab"));
#ifdef Q_OS_MACOS
